...
<Tailwind>
  <div className="font-[arial]">
      ...
      <p className="p-0 leading-5">
        All items below correspond to work completed in the month of January 2024. Payment is due within 15 days of receipt of
        this invoice.
      ...
      <div className="bg-blue-100 p-3 rounded-md border-blue-300 text-blue-800 text-sm">
        On January 1st 2024, Onedoc users will be upgraded free of charge
