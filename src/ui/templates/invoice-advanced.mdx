        ...
        <div className="flex-grow flex flex-col p-3 pt-2">
          ...
          <div className="text-2xl font-mono font-bold pb-2">
            ...
            <Footnote style={{footnoteDisplay: 'inline'}}>
              This payment may be installed in 3 monthly payments of $345.00. For more client information, check out <a href="https://www.kubefinance.com/" target="_blank" className="underline">www.kubefinance.com/#faq</a>.
            </Footnote>
          </div>
