...
<Tailwind>
  ...
  <main className="text-slate-800 font-[inter]">
    ...
    <div className="my-6">
      ...
      <BarChart width={730} height={250} data={dailyData} margin={{
        top: 20,
        left: 10,
        right: 10,
      }} style={{
        ...
        <XAxis axisLine={false} dataKey="date" type="number" scale="time" domain={[
          new Date("2024-01-01").getTime(),
          new Date("2024-01-14").getTime()
        ]} tickFormatter={(date) => new Date(date).toLocaleDateString()} ticks={
          dailyData.map((d, i) => (i + 3) % 7 === 0 ? d.date : null).filter(d => d !== null)
        } />
    ...
    <div className="flex -mx-4">
      <div className="basis-0 flex-grow m-4 bg-slate-100 rounded-xl p-6">
        ...
        <PieChart width={300} height={160} className="my-6" style={{
        width: "100%",
        height: "auto",
      }}>
          <Pie
