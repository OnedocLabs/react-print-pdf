...
<Frame type="glass"><img src="../../images/previews/tailwind-d34cd362/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid black' }} /></Frame>
...
<Frame type="glass"><img src="../../images/previews/tailwind-841def4d/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid black' }} /></Frame>
