...
<Frame type="glass"><img src="../../images/previews/margins-db4795b6/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid black' }} /></Frame>
