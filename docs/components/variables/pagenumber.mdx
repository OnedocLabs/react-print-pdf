...
<Frame background="subtle"><img src="../../images/previews/pagenumber-cc94f6f7/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid gray' }} /></Frame>
...
<Frame background="subtle"><img src="../../images/previews/pagenumber-7e3be4c3/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid gray' }} /></Frame>
