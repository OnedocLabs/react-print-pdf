...
<Frame type="glass"><img src="../images/previews/latex-acc77e37/document.1.jpg" style={{ maxHeight: '400px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
...
<Frame type="glass"><img src="../images/previews/latex-a546b40a/document.1.jpg" style={{ maxHeight: '400px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
