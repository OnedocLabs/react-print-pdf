...
<Frame background="subtle"><img src="../../images/previews/markdown-c8d0ecd4/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid gray' }} /></Frame>
...
<Frame background="subtle"><img src="../../images/previews/markdown-882cc486/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid gray' }} /></Frame>
