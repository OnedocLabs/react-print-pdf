...
<Frame type="glass"><img src="../../images/previews/pagebottom-206d811e/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid black' }} /></Frame>
