...
<Frame background="subtle"><img src="../../images/previews/floatbottom-9a3986d7/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid gray' }} /></Frame>
