...
<Frame type="glass"><img src="../images/previews/tailwind-a680f7a8/document.1.jpg" style={{ maxHeight: '400px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
...
<Frame type="glass"><img src="../images/previews/tailwind-c517bd48/document.1.jpg" style={{ maxHeight: '400px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
