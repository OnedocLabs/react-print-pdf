...
<Frame type="glass"><img src="../images/previews/tailwind-867375c6/document.1.jpg" style={{ height: '400px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
...
<Frame type="glass"><img src="../images/previews/tailwind-46351f5d/document.1.jpg" style={{ height: '400px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
...
(
<Tailwind twConfig={ { theme: { extend: { colors: { primary: "#6484cf", }, }, }, } }>
...
<ResponseField name="twConfig" type="Omit<Config, 'content'>" required={false}>
