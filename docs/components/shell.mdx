...
<Frame type="glass">
  <img
    ...
    src="images/previews/pagetop-3b19c9c1/document.1.jpg"
    style={{ height: "400px" }}
  />
</Frame>
...
``` ```css base.css @import url("https://fonts.googleapis.com/css2?family=Inter:wght@400;700&display=swap");
...
<Frame type="glass">
  <img
    className="shadow shadow-black/20"
    src="images/previews/pagebottom-f3b9554c/document.1.jpg"
    style={{ height: "400px" }}
  />
</Frame>
...
<Frame type="glass">
  <img
    className="shadow shadow-black/20"
    src="images/previews/floatbottom-11460a72/document.jpg"
    style={{ height: "400px" }}
  />
</Frame>
