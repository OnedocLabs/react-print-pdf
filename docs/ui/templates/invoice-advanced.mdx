...
<Frame type="glass"><img src="../../images/previews/ui-templates-invoice-advanced-c6069b2e/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
