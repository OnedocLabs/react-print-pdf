...
<Frame type="glass"><img src="../../images/previews/ui-templates-invoice-advanced-1b909556/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
