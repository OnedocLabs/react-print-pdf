...
<Frame type="glass"><img src="../../images/previews/ui-templates-receipt-280fabfa/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
