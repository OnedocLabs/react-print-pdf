...
<Frame type="glass"><img src="../../images/previews/ui-templates-receipt-b96ccc94/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
