...
<Frame background="subtle"><img src="../../images/previews/ui-templates-receipt-3f97df85/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid #E5E4E2' }} /></Frame>
