...
<Frame type="glass"><img src="../../images/previews/ui-templates-receipt-d7b79a68/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
