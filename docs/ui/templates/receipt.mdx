...
<Frame type="glass"><img src="https://github.com/OnedocLabs/react-print-pdf/blob/ffo-48-include-documentation-for-the-react-print-library-with/docs/images/previews/ui-templates-receipt-3f97df85/document.1.jpg?raw=true" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
