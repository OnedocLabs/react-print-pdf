...
<Frame type="glass"><img src="../../images/previews/ui-templates-invoice-456b2ad0/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
