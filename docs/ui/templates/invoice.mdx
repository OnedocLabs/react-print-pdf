...
<Frame type="glass"><img src="../../images/previews/ui-templates-invoice-2762523d/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
...
<Tailwind>
  <div className="font-[arial]">
    <div className="flex justify-between items-end pb-4 mb-8">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" enableBackground="new 0 0 46.15 9.31" version="1.1" viewBox="0 0 46.15 9.31" xmlSpace="preserve" fill="black"
        {...props}>
    ...
    <p className="p-0 leading-5">
      All items below correspond to work completed in the month of January 2024. Payment is due within 15 days of receipt of this invoice.
