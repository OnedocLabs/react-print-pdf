...
<Frame type="glass"><img src="../../images/previews/ui-templates-report-charts-97d1b8a0/document.1.jpg" style={{ maxHeight: '600px', borderRadius: "0.25rem", overflow: "hidden" }} /></Frame>
