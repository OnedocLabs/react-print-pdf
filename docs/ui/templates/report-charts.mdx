...
<Frame background="subtle"><img src="../../images/previews/ui-templates-report-charts-7d5e23ad/document.1.jpg" style={{  width: '100%', height: 'auto', maxHeight: '500px', borderRadius: "0.25rem", overflow: "hidden", border: '1px solid gray' }} /></Frame>
