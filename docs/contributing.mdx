...
```sh
git clone https://github.com/onedoclabs/react-print-pdf
```
...
4. Make your changes under the `/docs` folder and see a live preview at [localhost:3000](http://localhost:3000).
...
2. Install pip2pic dependencies:
...
5. Run local servers and watch for changes:

```sh
pnpm dev
```

6. Add a new folder under `src` and build your component.
