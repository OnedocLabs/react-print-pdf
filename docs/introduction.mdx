...
PDFs component created by react-print can be rendered, hosted (and more) with your preferred providers. We recommand using the [FileForge API](/api-reference/api-reference/generate) as it has been specificaly build to work with react-print.
