...
<Callout intent='note' title='React Print outputs an HTML string'>
  React Print is meant to help developers design PDFs. It outputs an HTML string that can be used to generate a PDF using a renderer like the [FileForge API](/api-reference/api-reference/generate).
</Callout>
...
<Note>
  ...
  the react-print community by [contributing](/react-print/contributing/contributing)
</Note>
